      ...
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <div className="mx-auto mb-5 inline-flex">
            <AppLogo href="/reset-password" variant="auth" showText={false} className="justify-center" />
          </div>
          <h1 className="font-display text-4xl text-ink-900 mb-1.5">Choose a new password</h1>
