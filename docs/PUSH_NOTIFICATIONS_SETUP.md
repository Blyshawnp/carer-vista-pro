...
- If diagnostics says saved subscription keys are stale, Refresh notifications should save the current browser `p256dh` and `auth` keys for the matching endpoint.
